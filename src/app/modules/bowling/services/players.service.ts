...
import { BowlingState } from 'src/app/modules/bowling/bowling.state';
import { Game } from 'src/app/modules/bowling/models/game';
import { Player } from 'src/app/modules/bowling/models/player';
