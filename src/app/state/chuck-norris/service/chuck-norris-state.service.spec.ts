  ...
  describe('effects', () => {
    describe('when fetchFact invoked', () => {
      it('should return getFact event', () => {
        const expected: Event<string, Store<ChuckNorrisFactState>> = new Event(actions.factActions.getFact(), store);
    ...
    describe('when fetchFactForCategory invoked', () => {
      it('should return getFactForCategory event', () => {
        ...
        const expected: Event<string, Store<ChuckNorrisFactState>> = new Event(actions.factActions.getFactForCategory({ payload: category }), store);
    ...
    describe('when fetchCategories invoked', () => {
      it('should return getAll event', () => {
        const expected: Event<string, Store<ChuckNorrisFactState>> = new Event(actions.categoryActions.getAll(), store);
    ...
    describe('when setSelectedCategory invoked', () => {
      it('should return categorySelected event', () => {
        const category = { category: 'dev' };
        const expected: Event<string, Store<ChuckNorrisFactState>> = new Event(actions.categoryActions.categorySelected({ payload: category }), store);
