...
describe('BookStateService', () =>
{
    ...
    describe('events', () =>
    {
        describe('when fetchBooks invoked', () =>
        {
            ...
            {
                const expected: StateEvent<string, Store<BooksState>> = new StateEvent(actions.bookActions.getAll(), store);

                const actual: StateEvent<string, Store<BooksState>> = service.events.fetchBooks();
        ...
        describe('when fetchCollections invoked', () =>
        {
            ...
            {
                const expected: StateEvent<string, Store<BooksState>> = new StateEvent(actions.collectionActions.getAll(), store);

                const actual: StateEvent<string, Store<BooksState>> = service.events.fetchCollections();
        ...
        describe('when addBook invoked', () =>
        {
            ...
            {
                const expected: StateEvent<string, Store<BooksState>> = new StateEvent(actions.collectionActions.addBook({ payload: '1' }), store);

                const actual: StateEvent<string, Store<BooksState>> = service.events.addBook('1');
        ...
        describe('when removeBook invoked', () =>
        {
            ...
            {
                const expected: StateEvent<string, Store<BooksState>> = new StateEvent(actions.collectionActions.removeBook({ payload: '1' }), store);

                const actual: StateEvent<string, Store<BooksState>> = service.events.removeBook('1');
        ...
        describe('when clearBooks invoked', () =>
        {
            ...
            {
                const expected: StateEvent<string, Store<BooksState>> = new StateEvent(actions.collectionActions.clearCollection(), store);

                const actual: StateEvent<string, Store<BooksState>> = service.events.clearCollection();
