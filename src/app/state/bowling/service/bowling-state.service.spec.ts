    ...
    describe('when addPlayer invoked', () => {
      ...
      describe('when removePlayer invoked', () => {
        it('should return removePlayer event', () => {
          const expected = new Event(actions.BowlingActions.removePlayer({ payload: { id: 1, players: [] } }), store);
      ...
      describe('when bowl invoked', () => {
        it('should return bowl event', () => {
          const expected = new Event(actions.BowlingActions.bowl({ payload: [] }), store);
      ...
      describe('when getRatings invoked', () => {
        it('should return getRatings event', () => {
          const expected = new Event(actions.BowlingActions.getRatings(), store);
      ...
      describe('when newGame invoked', () => {
        it('should return newGame event', () => {
          const expected = new Event(actions.BowlingActions.newGame(), store);
